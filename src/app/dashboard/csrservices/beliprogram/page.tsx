          ...
          {csrStatus === 0 || csrStatus === null ? (
            ...
            <div className="status-open">
              <Tabs defaultValue="program" className="w-full">
                ...
                <TabsContent value="riwayatprogram" className="mt-3 bg-[#f5f7fe]">
                    <div className="flex flex-col gap-y-6 py-4 px-12 pb-12"> 
                            ...
                            <Accordion type="single" className="flex flex-col gap-y-6" collapsible>
                                <AccordionItem value="item-1">
                                    <AccordionTrigger className="flex flex-row justify-between items-center rounded-xl bg-white p-6">
                                        ...
                                        <div>
                                            <h5 className="text-slate-700 text-sm">Selesai</h5>
                                        </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="flex flex-col items-center rounded-b-xl bg-white p-6 border-t border-slate-200">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                ...
                                                <h6 className="text-slate-800">Program 1</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Tanggal Bertemu</label>
                                                <h6 className="text-slate-800">18 Juli 2018</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Jenis Program</label>
                                                <h6 className="text-slate-800">Children</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Status</label>
                                                <h6 className="text-slate-800">Selesai</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                ...
                                <AccordionItem value="item-2">
                                    <AccordionTrigger className="flex flex-row justify-between items-center rounded-xl bg-white p-6">
                                        ...
                                        <div>
                                            <h5 className="text-slate-700 text-sm">Belum Dihubungi</h5>
                                        </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="flex flex-col items-center rounded-b-xl bg-white p-6 border-t border-slate-200">
                                        <div className="flex flex-row justify-between items-center w-full mb-8">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Nama Program</label>
                                                <h6 className="text-slate-800">Program 2</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Tanggal Bertemu</label>
                                                <h6 className="text-slate-800">18 Juli 2018</h6>
                                            ...
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Jenis Program</label>
                                                <h6 className="text-slate-800">Infrastruktur</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Status</label>
                                                <h6 className="text-slate-800">Belum Dihubungi</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">File Proposal</label>
                                                <h6 className="text-sky-500 cursor-pointer">Proposal.pdf</h6>
                                ...
                                <AccordionItem value="item-3">
                                    <AccordionTrigger className="flex flex-row justify-between items-center rounded-xl bg-white p-6">
                                        ...
                                        <div>
                                            <h5 className="text-slate-700 text-sm">Program Berlangsung</h5>
                                        </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="flex flex-col items-center rounded-b-xl bg-white p-6 border-t border-slate-200">
                                        <div className="flex flex-row justify-between items-center w-full mb-8">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Nama Program</label>
                                                <h6 className="text-slate-800">Program 3</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Tanggal Bertemu</label>
                                                <h6 className="text-slate-800">18 Juli 2018</h6>
                                            ...
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Jenis Program</label>
                                                <h6 className="text-slate-800">Disaster</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Status</label>
                                                <h6 className="text-slate-800">Program Berlangsung</h6>
                                            </div>
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">File Proposal</label>
                                                <h6 className="text-sky-500 cursor-pointer">Proposal.pdf</h6>
                                            ...
                                            <div className="w-1/2 flex flex-row gap-x-4 items-center pb-4">
                                                <label className="text-slate-600 w-[150px]">Laporan</label>
                                                <h6 className="text-slate-800">Tunggu sampai program selesai</h6>
                                            </div>
                                        </div>
                                        <div className="w-full flex justify-start items-center mt-4">
